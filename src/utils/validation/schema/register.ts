...
const register = (
  ...
  email: {
    rules: [
      ...
      { validation: minMax.maxLength(50, value, 'Email terlalu panjang (maksimal 50 karakter).'), }
    ],
  },
  phone_number: {
    rules: [
      { validation: minMax.required(value, 'Nama lengkap tidak boleh kosong.') },
      { validation: pattern.whatsAppEmail(value, 'Hanya diisi dengan nomor Whatsapp.'), },
      { validation: minMax.maxLength(15, value, 'Nomor Whatsapp terlalu panjang (maksimal 15 karakter).'), }
    ],
  },
